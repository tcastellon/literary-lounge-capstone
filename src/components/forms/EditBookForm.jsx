...
import { getBooksByReaderId, updateBook, updateBookRead } from "../../service/bookService";
...
export const EditBookForm = ({ currentReader }) => {
  ...
  useEffect(() => {
    getBooksByReaderId(currentReader.id).then((booksArray) => {
        const bookObj = booksArray.find((book) => book.bookId === parseInt(bookId))
      setBook(bookObj);
    });
